...
exports.worldplaneLexicon = void 0;
exports.getWorldplanePattern = getWorldplanePattern;
exports.listWorldplanePatterns = listWorldplanePatterns;
exports.worldplaneLexicon = [
    {
        key: "hostile_world_read",
        label: "Hostile World Read",
        summary: "The world is read as primarily dangerous, unpredictable, and against you.",
        distortedReads: [
    ...
    },
    {
        ...
        summary: "The world is read as a courtroom where you are constantly on trial.",
        distortedReads: [
    ...
    },
    {
        ...
        summary: "The world is read as unstable, fast‑shifting, and impossible to navigate.",
        distortedReads: [
    ...
    },
    {
        ...
        summary: "The world is read as relationally or spiritually barren — nothing alive, nothing growing.",
        distortedReads: [
 ...
 */
function getWorldplanePattern(key) {
    return exports.worldplaneLexicon.find(p => p.key === key);
}
/**
 * Returns all world‑plane patterns.
 */
function listWorldplanePatterns() {
    return exports.worldplaneLexicon;
}
//# sourceMappingURL=worldLexicon.js.map