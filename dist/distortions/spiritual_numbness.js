...
exports.spiritualNumbnessDistortion = void 0;
exports.spiritualNumbnessDistortion = {
    id: "spiritual_numbness",
    name: "Spiritual Numbness",
    subtype: "Disconnect from Meaning",
    description: "Spiritual numbness shows up when the internal system becomes desensitized to meaning, purpose, conviction, or connection with God. It often follows prolonged stress, disappointment, or emotional shutdown.",
    commonTriggers: [
    ...
    defaultIdentityAnchor: {
        summary: "Your identity is not defined by numbness. You are not abandoned, disconnected, or spiritually dead — you are being restored, renewed, and reawakened.",
    ...
    worldplaneInterpretation: {
        summary: "The environment is interpreted as spiritually empty or meaningless, even when real sources of connection and renewal are present but inaccessible due to emotional shutdown.",
    ...
    councilRuling: {
        summary: "The Council acknowledges the heaviness of numbness but rules that numbness cannot define identity, dictate spiritual reality, or determine future connection.",
        impactOnIdentity: "Your identity is not ‘the disconnected one.’ You are being renewed and reawakened.",
        impactOnInterpretation: "Numbness is not permitted to interpret silence as absence or exhaustion as abandonment."
    },
    formationPathway: {
        primaryObjective: "Reawaken spiritual sensitivity through gentle, consistent practices and reconnection to meaning.",
        practices: [
        ...
        anchorReminder: "Numbness is a season, not a sentence. Renewal is already underway."
    }
};
//# sourceMappingURL=spiritual_numbness.js.map