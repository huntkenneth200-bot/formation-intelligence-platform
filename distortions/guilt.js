...
exports.guiltDistortion = void 0;
exports.guiltDistortion = {
    id: "guilt",
    name: "Guilt",
    subtype: "Moral Weight",
    description: "Guilt shows up as a heavy internal pressure that insists you must repay, fix, or punish yourself for past actions — even after forgiveness, restoration, or resolution has already occurred.",
    commonTriggers: [
    ...
    defaultIdentityAnchor: {
        summary: "You are not defined by your failures. You are forgiven, restored, and not required to self‑punish to prove sincerity.",
    ...
    worldplaneInterpretation: {
        summary: "The environment is interpreted as a moral scoreboard where every misstep must be repaid, even when the situation no longer requires repayment.",
    ...
    councilRuling: {
        summary: "The Council acknowledges the moral seriousness of guilt but rules that guilt cannot demand ongoing self‑punishment or restrict restored movement.",
        impactOnIdentity: "Your identity is not ‘the offender,’ ‘the disappointment,’ or ‘the one who must repay.’ You are restored and capable of walking forward.",
        impactOnInterpretation: "Guilt is not permitted to interpret every situation as requiring repayment or self‑punishment."
    },
    formationPathway: {
        primaryObjective: "Restore moral clarity, receive forgiveness fully, and break the cycle of self‑punishment.",
        practices: [
        ...
        anchorReminder: "Guilt may remind you of what mattered, but it cannot demand endless repayment. You are restored."
    }
};
//# sourceMappingURL=guilt.js.map