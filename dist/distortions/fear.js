...
exports.fearDistortion = void 0;
exports.fearDistortion = {
    id: "fear",
    name: "Fear",
    subtype: "Threat Anticipation",
    description: "Fear shows up as a heightened sense of threat, where the mind overestimates danger and underestimates capacity, support, or covering.",
    commonTriggers: [
    ...
    defaultIdentityAnchor: {
        summary: "You are not abandoned to threat. You are held, covered, and not left to face this alone.",
    ...
    worldplaneInterpretation: {
        summary: "The environment is being interpreted as more hostile and unstable than it actually is, often because past experiences of real threat are being projected onto the present.",
    ...
    councilRuling: {
        summary: "The Council acknowledges the presence of fear as a response to perceived threat, but rules that fear does not have authority to define identity or dictate every interpretation of the environment.",
        impactOnIdentity: "Your identity is not ‘the anxious one’ or ‘the fragile one.’ You are capable of standing, deciding, and moving even when you feel afraid.",
        impactOnInterpretation: "Fear is allowed to signal that something matters, but it is not permitted to be the only voice interpreting what is happening."
    },
    formationPathway: {
        primaryObjective: "Restore a grounded sense of safety while building capacity to move forward in the presence of uncertainty.",
        practices: [
        ...
        anchorReminder: "Fear may be loud, but it is not Lord. You are not alone, and you are not without covering."
    }
};
//# sourceMappingURL=fear.js.map