...
exports.shameDistortion = void 0;
exports.shameDistortion = {
    id: "shame",
    name: "Shame",
    subtype: "Self‑Condemnation",
    description: "Shame shows up as a collapse of identity, where the mind interprets mistakes, weaknesses, or past events as proof of personal defect or unworthiness.",
    commonTriggers: [
    ...
    defaultIdentityAnchor: {
        summary: "Your identity is not defined by failure, weakness, or past events. You are not defective — you are being restored.",
    ...
    worldplaneInterpretation: {
        summary: "The environment is interpreted as a courtroom where every action is judged and every flaw is fatal, even when no real threat is present.",
    ...
    councilRuling: {
        summary: "The Council acknowledges the emotional weight of shame but rules that shame has no authority to define identity or restrict movement.",
        impactOnIdentity: "Your identity is not ‘the failure,’ ‘the disappointment,’ or ‘the problem.’ You are being formed, not condemned.",
        impactOnInterpretation: "Shame is not permitted to interpret every interaction as judgment or rejection."
    },
    formationPathway: {
        primaryObjective: "Restore dignity, visibility, and grounded identity while breaking the reflex to hide.",
        practices: [
        ...
        anchorReminder: "Shame is loud, but it is not Lord. You are not defined by your lowest moments."
    }
};
